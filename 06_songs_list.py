...
three_songs = ['Halo', 'Enjoy the Silence', 'Clean']

total_time = 0
for song in violator_songs_list:
  if song[0] in three_songs:
      total_time += song[1]
...
three_songs_2 = ['Sweetest Perfection', 'Policy of Truth', 'Blue Dress']
total_time_2 = 0
for song in three_songs_2:
    if song in violator_songs_dict:
        total_time_2 += violator_songs_dict[song]
